...
from adetailer.ui import StartfkInfo, adui, ordinal, suffix
...
class AfterDetailerScript(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        components, infotext_fields = adui(num_models, is_img2img, startfk_info)
    ...
    def get_ultralytics_device() -> str:
        ...
        vram_args = ["lowvram", "medvram", "medvram_sxdxl"]
