...
def one_ui_group(n: int, is_img2img: bool, startfk_info: StartfkInfo):
    w = Widgets()
    state = gr.State({})
    ...
    with gr.Row():
        model_choices = (
            [*startfk_info.ad_model_list, "None"]
            if n == 0
            else ["None", *startfk_info.ad_model_list]
        )
    ...
    with gr.Group():
        ...
        with gr.Accordion(
            ...
            inpainting(w, n, is_img2img, startfk_info)

    with gr.Group():
        controlnet(w, n, is_img2img)

    all_inputs = [state, *w.tolist()]
    target_button = startfk_info.i2i_button if is_img2img else startfk_info.t2i_button
    target_button.click(
...
def inpainting(w: Widgets, n: int, is_img2img: bool, startfk_info: StartfkInfo):
    eid = partial(elem_id, n=n, is_img2img=is_img2img)
    ...
    with gr.Group():
        ...
        with gr.Row():
            with gr.Column(variant="compact"):
                ...
                ckpts = ["Use same checkpoint", *startfk_info.checkpoints_list]
            ...
            with gr.Column(variant="compact"):
                ...
                vaes = ["Use same VAE", *startfk_info.vae_list]
        ...
        with gr.Row(), gr.Column(variant="compact"):
            ...
            w.ad_sampler = gr.Dropdown(
                ...
                choices=startfk_info.sampler_names,
                value=startfk_info.sampler_names[0],
                visible=True,
